                    ...
                    if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
                        ...
                        foreach ($book_counts as $book_id => $count) {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                ?>
                                <div class="mb-3">
                                    <img src="<?php echo $book['thumbnail']; ?>" class="img-fluid" style="max-width: 100px;" alt="<?php echo $book['name']; ?>">
                                    <span><?php echo $book['name']; ?></span>
                                    <span class="float-end">
                                        Price: $<?php echo $book['price']; ?> |
                                        Count: <?php echo $count; ?> |
                                        Total: $<?php echo $book['price'] * $count; ?>
                                    </span>
                                    <div class="clearfix"></div>
                                    <div class="btn-group mt-2" role="group" aria-label="Book Quantity">
